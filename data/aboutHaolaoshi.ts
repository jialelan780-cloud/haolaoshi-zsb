...
export const historyTimeline = [
  {
    year: "2018",
    content:
      "开始聚焦专升本升学培训，围绕高职学生升本需求搭建课程与服务体系。",
    tags: ["业务起步", "专升本赛道"],
  },
  {
    year: "2020",
    content:
      "逐步建立标准化教研体系，形成高等数学、大学英语、大学语文等分科教学产品，并完善入学测评、阶段测评、课后督学等基础服务。",
    tags: ["教研体系", "分科教学", "督学服务"],
  },
  {
    year: "2022",
    content:
      "浙江滨江教学点持续服务浙江专升本学生，围绕浙江统招专升本考情、院校录取规则和学生基础差异，强化本地化教研与班级分层。",
    tags: ["滨江本地化", "班级分层"],
  },
  {
    year: "2024",
    content:
      "完善定向实习班、启航班、凌云班、全日制班、圆梦定制班等分层产品体系，覆盖实习党、基础薄弱学生、公办冲刺学生和全日制备考学生。",
    tags: ["分层班型", "产品体系"],
  },
  {
    year: "2026",
    content:
      "继续升级数据化学情追踪、老师带班结果展示、学生录取结果可视化和志愿规划服务，让家长能看到真实可追踪的升学过程。",
    tags: ["数据化升学结果", "学情追踪", "志愿规划"],
  },
];
...
export const comparison = {
  ...
  rows: [
    { dim: "报考资格", full: "仅限浙江省内全日制专科应届毕业生（外省户籍在浙读专科可报，浙江户籍在外省读专科不可报）", part: "年满 18 周岁、专科及以上学历即可，无地域 / 户籍 / 年龄限制" },
    { dim: "考试机会", full: "一生仅一次", part: "无次数限制，毕业多年也能考" },
    { dim: "学习方式", full: "全日制在校学习 2 年（医学类 3 年），与统招本科生同班、共享资源", part: "自学 / 业余 / 函授 / 线上为主，基本无需到校" },
    { dim: "学历性质", full: "普通高等教育", part: "成人高等教育" },
    { dim: "第一学历", full: "本科", part: "专科（本科为最高学历）" },
    { dim: "毕业证书", full: "普通高等学校毕业证书，标注「专科起点本科学习」", part: "成人高等教育毕业证书，标注成考 / 自考 / 国开" },
    { dim: "学信网类型", full: "普通高等教育", part: "成人高等教育" },
    { dim: "企业认可度", full: "与高考统招本科完全相同，企业普遍认可", part: "大型国企 / 央企 / 外企认可度较低，中小企业部分认可" },
    { dim: "考公考编", full: "可报考所有要求「本科及以上」的岗位", part: "大部分岗位认可，明确要求「全日制本科」的岗位除外" },
    {
      dim: "适合人群",
      full: "在校专科应届生、想获得全日制本科学历、未来计划考研考公进国企的学生",
      part: "已毕业 / 在职、用于提升学历、评职称、考资格证的人群",
    },
  ],
  conclusion:
...
export const policyTimeline = [
  ...
  { stage: "3 月", content: "网上报名、资格审核、缴费。" },
  { stage: "4 月", content: "参加浙江专升本统一考试。" },
  { stage: "5 月", content: "成绩公布、分数线公布、志愿填报和录取。" },
  { stage: "6-7 月", content: "录取结果确认，等待本科入学通知。" },
  { stage: "9 月", content: "进入本科院校学习。" },
];

/* ---------- 8. 2020-2026 省控线 ---------- */
export const provincialLines = {
  years: [2020, 2021, 2022, 2023, 2024, 2025, 2026],
  rows: [
    { category: "文史类", values: [205, 206, 218, 221, 213, 213, 222] },
    { category: "法学类", values: [102, 183, 182, 177, 144, 185, 198] },
    { category: "教育类", values: [224, 209, 222, 227, 211, 217, 226] },
    { category: "艺术类", values: [148, 156, 172, 178, 198, 201, 210] },
    { category: "理工类", values: [104, 156, 183, 191, 171, 187, 182] },
    { category: "经管类", values: [80, 138, 182, 178, 173, 175, 156] },
    { category: "农学类", values: [143, 83, 165, 165, 170, 137, 214] },
    { category: "医学类", values: [183, 191, 215, 212, 189, 195, 220] },
  ],
  note: "2026 年数据为预测参考，最终以浙江省教育考试院官方公布为准；多数类别省控线存在波动，热门专业实际录取分数通常高于省控线。",
};
